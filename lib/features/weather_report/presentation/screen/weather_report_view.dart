...
import 'package:weather_app/features/weather_report/presentation/screen/daily_report_screen.dart';
              ...
              SliverToBoxAdapter(
                child: Column(
                  children: [
                    ...
                    GestureDetector(
                      onTap: ()=> Navigator.push(context, MaterialPageRoute(builder: (context)=> DailyReportScreen(dailyHumidityModel:  state.weatherReport.dailyHumidityModel))),
                      child: WindCard(weatherDataModel: state.weatherReport)),
