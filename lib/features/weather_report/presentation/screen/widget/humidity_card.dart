...
import 'package:weather_app/features/weather_report/presentation/screen/widget/weather_progress_bar.dart';
      ...
      child: Row(
        ...
        children: [
          WeatherReportCard<double>(
            ...
            valueSelector: (e) => e.weatherWindSpeed,
            unit: "km/h",
            cardTitle: "Wind Speed",
            iconsColor: context.theme.cardLabel,
            icon: Icon(Icons.navigation_rounded, color: context.theme.wind),
          ),
          SizedBox(width: 16),
          WeatherReportCard<int>(
            ...
            unit: "%",
            iconsColor: context.theme.cardLabel,
            icon: Icon(Icons.hub_rounded, color: context.theme.wind),
            cardTitle: "Humidity",
            widget: WeatherProgressBar(),
          ),
        ],
      ),
    );
